...
//       strip.setPixelColor(i,Wheel(map(0,0,strip.numPixels()-1,30,150)));
        if (i == 0) {
          strip.setPixelColor(i,Color(0,0,255)); //Set color for LED 2 to Blue
        } else {
          strip.setPixelColor(i,Color(255, 80, 0)); //Set color for LED 2 to Blue
        }
    } 
